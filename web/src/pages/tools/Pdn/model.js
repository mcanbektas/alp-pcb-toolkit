...
//
// Sıra ekrandaki (index.jsx) görünüm sırasıyla birebir eşleşir: ΔV kaynağı
// (Vrail/tolerancePct ya da deltaV) önce, ΔI sonra — ekranda kaynak alanları
// her zaman ΔI'dan önce çizilir. Bu sıra bozulursa rapor girdi listesi ekran
// panelinden farklı sırayla çıkar (docs/uyelik-ve-rapor-plani.md §15).
