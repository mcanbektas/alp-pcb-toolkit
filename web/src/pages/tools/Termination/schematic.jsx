...
const TerminationSchematic = forwardRef(function TerminationSchematic({ r, text }, ref) {
  const type = r.type ?? TERM_SERIES
  const show = r.ok

  return (
    <Schematic ref={ref} viewBox="0 0 276 160" title={text.title[type]} caption={text.caption[type]}>
...
export default TerminationSchematic
