...
describe('SingleEnded F2 text yolları', () => {
  for (const lang of langs) {
    it(`(${lang}) yeni yollar tanımlı ve doğru türde`, () => {
      ...
      // F3 geometri ayrıntısı alanları (trapez / mask / gömülü)
      expect(typeof t.fields.xsection.label).toBe('string')
      expect(typeof t.fields.dTop.label).toBe('string')
      expect(typeof t.fields.coverType.label).toBe('string')
      expect(typeof t.fields.maskT.label).toBe('string')
      expect(typeof t.fields.maskEpsR.label).toBe('string')
      expect(typeof t.fields.coverH.label).toBe('string')
      expect(typeof t.xsectionLabel.rect).toBe('string')
      expect(typeof t.xsectionLabel.trap).toBe('string')
      expect(typeof t.coverLabel.air).toBe('string')
      expect(typeof t.coverLabel.mask).toBe('string')
      expect(typeof t.coverLabel.embedded).toBe('string')
      expect(typeof t.fieldLabels.dTop).toBe('string')
      expect(typeof t.fieldLabels.maskT).toBe('string')
      expect(typeof t.fieldLabels.maskEpsR).toBe('string')
      expect(typeof t.fieldLabels.coverH).toBe('string')
